...
describe("DelegateAuthToUpstreamField", () => {
  ...
  it("reflects a saved delegate_auth_to_upstream value when editing", () => {
    render(
      <Form initialValues={{ delegate_auth_to_upstream: true, available_on_public_internet: true }}>
        <DelegateAuthToUpstreamField mcpServer={{ delegate_auth_to_upstream: true } as any} />
      </Form>,
    );
